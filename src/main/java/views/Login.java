...
public class Login extends JFrame {
	...
	public Login() {
		...
		JPanel btnNuevoUser = new JPanel();
		btnNuevoUser.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				btnNuevoUser.setBackground(new Color(0, 156, 223));
			}
		
			@Override
			public void mouseExited(MouseEvent e) {
				btnNuevoUser.setBackground(SystemColor.textHighlight);
			}
			@Override
			public void mouseClicked(MouseEvent e) {
		...
		btnNuevoUser.setBackground(SystemColor.textHighlight);
		btnNuevoUser.setBounds(200, 431, 200, 44); //65, 431
		panel.add(btnNuevoUser);
		btnNuevoUser.setLayout(null);
		btnNuevoUser.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
		
		JLabel lblNewLabel2 = new JLabel("NUEVO USUARIO");
		lblNewLabel2.setBounds(0, 0, 200, 44);
		btnNuevoUser.add(lblNewLabel2);
	...
	private boolean verificaUsuario() {
		...
		boolean existeUsuario = this.usuariosController.filtra(txtUsuario.getText(), contrase);
