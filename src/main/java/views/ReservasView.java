...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		txtFechaSalida.addPropertyChangeListener(new PropertyChangeListener() {
			public void propertyChange(PropertyChangeEvent evt) {
				...
				if(txtFechaEntrada.getDate() != null && txtFechaSalida.getDate() != null) {
					...
					long miliSalida =  txtFechaSalida.getCalendar().getTimeInMillis();
					long miliEntrada =  txtFechaEntrada.getCalendar().getTimeInMillis() ;
					long dias = (miliSalida - miliEntrada )/milisecondsByDay;
					System.out.println(dias);
					
					totalTarifa = String.valueOf(dias*600); 
					cargaValorTarifa("$ "+ totalTarifa);
		...
		txtValor.setBounds(68, 328, 100, 33);// (78, 328, 43, 33) 
	...
	public void cargaValorTarifa( String totalTarifa){
		
		txtValor.setText(totalTarifa);
		
	}
		
	private int guardar() {
		
       var reservas = new Reservas(  txtFechaEntrada.getDate(),
    		   						 txtFechaSalida.getDate(),
    		   						txtValor.getText(),
    		   						(String) txtFormaPago.getSelectedItem());

			this.reservasController.guardar(reservas);
