...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped(int idReserva) {
		...
		btnguardar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				boolean nombreCompleto = txtNombre != null && txtApellido != null && txtTelefono != null;
				if (nombreCompleto && txtFechaN.getDate() != null ) {		
	...
	private boolean esNombreValido(String cadena) {
		return cadena != null && cadena.matches("[a-z A-Z]+");
	}
	
	private void guardar() {
		
		boolean valido = esNombreValido(txtNombre.getText()) && esNombreValido(txtApellido.getText());
		if(valido && esNumero(txtTelefono.getText())) {
			
			var huespedes = new Huespedes( txtNombre.getText(), txtApellido.getText(), txtFechaN.getDate(),
			...
			JOptionPane.showMessageDialog(null, "Tu numero de Reserva es: "+ txtNreserva.getText());
			
			dispose();
			Exito ventanaExito = new Exito();
			ventanaExito.setVisible(true);
		}else {
			JOptionPane.showMessageDialog(null, "Nombre o Telefono no validos!!");
		}       
